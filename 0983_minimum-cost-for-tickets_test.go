...
func Test_dpMincostTickets11(t *testing.T) {
	type args struct {
		days  []int
		costs []int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := dpMincostTickets11(tt.args.days, tt.args.costs); got != tt.want {
				t.Errorf("dpMincostTickets11() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_mincostTickets22(t *testing.T) {
	type args struct {
		days  []int
		costs []int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := mincostTickets22(tt.args.days, tt.args.costs); got != tt.want {
				t.Errorf("mincostTickets22() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_mincostTickets33(t *testing.T) {
	type args struct {
		days  []int
		costs []int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := mincostTickets33(tt.args.days, tt.args.costs); got != tt.want {
